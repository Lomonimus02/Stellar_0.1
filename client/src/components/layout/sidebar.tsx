...
export const Sidebar = forwardRef<HTMLElement, SidebarProps>(
  ...
  const roleAccess = {
    ...
    [UserRoleEnum.SCHOOL_ADMIN]: ["dashboard", "users", "subjects-management", "classes-management", "school-admin-schedule-menu", "grading-systems", "analytics", "messages", "notifications", "settings", "support"],
    ...
    [UserRoleEnum.PRINCIPAL]: ["dashboard", "users", "classes-management", "school-admin-schedule-menu", "grades", "grading-systems", "analytics", "messages", "documents", "settings", "support"],
    [UserRoleEnum.VICE_PRINCIPAL]: ["dashboard", "users", "classes-management", "schedule", "grades", "grading-systems", "analytics", "messages", "documents", "settings", "support"]
  };
  ...
  const navItems: NavItem[] = [
    ...
    { id: "classes-management", label: "Классы", icon: <SchoolIcon className="h-[22px] w-[22px] mr-4" />, href: "/classes-management" },
    ...
    { id: "grading-systems", label: "Управление", icon: <ClipboardListIcon className="h-[22px] w-[22px] mr-4" />, href: "/grading-systems" },
