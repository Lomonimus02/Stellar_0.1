...
export default function MessagesPage() {
  ...
  const updateChatMutation = useMutation({
    mutationFn: async (data: { chatId: number, name: string, avatarUrl?: string | null }) => {
                        ...
                        >
                          <Avatar className="h-10 w-10 mr-3">
                            <AvatarImage
                              ...
                              alt={chatName}
                              onError={(e) => {
                                console.log('Failed to load avatar:', chat.avatarUrl);
                              }}
                            />
                    ...
                    <div className="flex items-center">
                      <Avatar className="h-10 w-10 mr-3">
                        <AvatarImage
                          ...
                          onError={(e) => {
                            console.log('Failed to load selected chat avatar:', selectedChat.avatarUrl);
                          }}
                        />
